...
packages := if os_name == "Darwin" { "certs claude fastfetch git hermes karabiner lopilot mise tmux zsh"
} else { "claude dunst fastfetch git hermes lopilot mise picom redshift rofi tin tmux yazi zsh" }
