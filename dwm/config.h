...
static const Rule rules[] = {
	...
	{ "Alacritty",		NULL,		"ncmpcpp",	1 << 6,			1, 				1,		-1 }, // appears on tag 7, floating, centered
...
static const char *ncmpcppcmd[] = { "alacritty", "-T", "ncmpcpp", "-o", "window.dimensions.columns=120", "-o", "window.dimensions.lines=40", "-e", "ncmpcpp", NULL };
